...
def main():
    ...
    # Collect activations for layers we want to analyze
    target_layers = [20]
    ...
    for layer in target_layers:
        ...
        top_features = analyze_sae_features(
            sae, 
        ...
        for feature_idx, correlation in top_features:
            ...
            print(f"See feature details at: https://neuronpedia.org/gemma-2-2b/{layer}-gemmascope-res-16k/{feature_idx}")
        
        top_features = top_features[:1]
        # Evaluate on test set
        test_accuracy = evaluate_sae_features(
            sae,
            activation_loaders['test'],
    ...
    for result in results:
        ...
        for feature_idx, correlation in result['top_features']:
            ...
            print(f"https://neuronpedia.org/gemma-2-2b/{result['layer']}-gemmascope-res-16k/{feature_idx}")
